...
(function(window) {
   ...
   * @since 18-12-27
  */
  if (typeof define === "function" && define.amd) {       //AMD模块加载方式
    define(function() {
      return ZeroClipboard;
    });
  } else if (typeof module === "object" && module && typeof module.exports === "object" && module.exports) {      //CommonJs  输出模块
    module.exports = ZeroClipboard;
  // } else {
  //   window.ZeroClipboard = ZeroClipboard;
  }
  window.ZeroClipboard = ZeroClipboard;         // add since 18-12-27     全局注册 ZeroClipboard
})(function() {
  return this;
}());